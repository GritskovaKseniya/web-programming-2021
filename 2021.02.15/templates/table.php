<div class="row">
    <div class="col text-center" style="margin-top: 16px"><h4>Table</h4></div>
</div>
<div class="row">
    <table style="width: 98%;" class="table table-bordered table-striped mr-3 ml-3" style="margin-top: 15px"  id="my_table">
        <tr><th>ID</th><th>Name</th><th>Description</th><th>Time</th><th>Date</th><th>Edit</th><th>Delete</th></tr>  
